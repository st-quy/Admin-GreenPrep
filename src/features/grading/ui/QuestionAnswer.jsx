  ...
  const studentAnswers = () => {
    if (isSpeaking) {
      const fakeSpeakingAnswers = {
        ...
        4: ["https://www.learningcontainer.com/wp-content/uploads/2020/02/Kalimba.mp3"],
      }
      return (
    ...
    const fakeWritingAnswers = {
      1: ["Early morning.", "At the local coffee shop.", "Watched a movie.", "A modern apartment.", "The kitchen."],
      2: [
    ...
    return (
      <div className="whitespace-pre-line">
        {fakeWritingAnswers[currentPart]?.[currentQuestionIndex] || "No answer available"}
      </div>
    )
  }
  return (
